...
#From https://learn.microsoft.com/en-us/azure/virtual-desktop/set-up-customize-master-image
...
try {
    ...
    $FsLogixInstallFile = Get-ChildItem -Path .\fslogix -Recurse -Include 'FSLogixAppsSetup.exe' | Where-Object {$_.FullName -match 'x64'}
    "Downloaded FSLogix"
} 
catch {
